 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _p="firebase-heartbeat-database",yp=1,Xn="firebase-heartbeat-store";let Ai=null;function ju(){return Ai||(Ai=Lf(_p,yp,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Xn)}catch(t){console.warn(t)}}}}).catch(n=>{throw gt.create("idb-open",{originalErrorMessage:n.message})})),Ai}async function Ep(n){try{const t=(await ju()).transaction(Xn),r=await t.objectStore(Xn).get($u(n));return await t.done,r}catch(e){if(e instanceof nt)Xe.warn(e.message);else{const t=gt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Xe.warn(t.message)}}}async function nc(n,e){try{const r=(await ju()).transaction(Xn,"readwrite");await r.objectStore(Xn).put(e,$u(n)),await r.done}catch(t){if(t instanceof nt)Xe.warn(t.message);else{const r=gt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Xe.warn(r.message)}}}function $u(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rp(n){an(new Mt("platform-logger",e=>new Uf(e),"PRIVATE")),an(new Mt("heartbeat",e=>new wp(e),"PRIVATE")),mt(Oi,ec,n),mt(Oi,ec,"esm2017"),mt("fire-js","")}Rp("");var Cp="firebase",Sp="11.2.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */mt(Cp,Sp,"app");var ic=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Zu("Invalid base64 string: "+i):i}}(e);return new de(t)}static fromUint8Array(e){const t=function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i}(e);return new de(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return $(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}de.EMPTY_BYTE_STRING=new de("");const zp=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Tt(n){if(W(!!n),typeof n=="string"){let e=0;const t=zp.exec(n);if(W(!!t),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:ne(n.seconds),nanos:ne(n.nanos)}}function ne(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function wt(n){return typeof n=="string"?de.fromBase64String(n):de.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zi(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function B_(){return Kc()==="http:"||Kc()==="https:"}function Kc(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function q_(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(B_()||of()||"connection"in navigator)?navigator.onLine:!0}function j_(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _r{constructor(e,t){this.shortDelay=e,this.longDelay=t,tt(t>e,"Short delay should be less than long delay!"),this.isMobile=nf()||af()}get(){return q_()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Q_(n,e){return bt(n,"POST","/v1/accounts:delete",e)}async function Ah(n,e){return bt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ir(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof nt&&J_(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function J_({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yc=new Map;function Qe(n){tt(n instanceof Function,"Expected a class definition");let e=Yc.get(n);return e?(tt(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Yc.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oy(n,e={}){return bt(n,"GET","/v2/passwordPolicy",St(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Ke("not implemented")}_getIdTokenResponse(e){return Ke("not implemented")}_linkToIdToken(e,t){return Ke("not implemented")}_getReauthenticationResolver(e){return Ke("not implemented")}}async function vy(n,e){return bt(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ay(n,e){return yr(n,"POST","/v1/accounts:signInWithPassword",St(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ry(n,e){return yr(n,"POST","/v1/accounts:signInWithEmailLink",St(n,e))}async function Cy(n,e){return yr(n,"POST","/v1/accounts:signInWithEmailLink",St(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ky(n,e){return yr(n,"POST","/v1/accounts:signUp",St(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qh(n,e,t=!1){if(Me(n.app))return Promise.reject(Je(n));const r="signIn",s=await Bh(n,r,e),i=await Ft._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Oy(n,e){return qh(Gt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jh(n){const e=Gt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Vy(n,e,t){if(Me(n.app))return Promise.reject(Je(n));const r=Gt(n),a=await to(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",ky).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&jh(n),l}),u=await Ft._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(u.user),u}function Ly(n,e,t){return Me(n.app)?Promise.reject(Je(n)):Oy(ce(n),wn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&jh(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function My(n,e){return ce(n).setPersistence(e)}function xy(n,e,t,r){return ce(n).onIdTokenChanged(e,t,r)}function Uy(n,e,t){return ce(n).beforeAuthStateChanged(e,t)}function $h(n){return ce(n).signOut()}const Cs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qh(){return typeof Be().WorkerGlobalScope<"u"&&typeof Be().importScripts=="function"}async function Gy(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Hy(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function zy(){return Qh()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zy(n,e){return e?Qe(e):(M(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zh{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:u}=e;if(a){this.reject(a);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(u)(l))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return eE;case"linkViaPopup":case"linkViaRedirect":return nE;case"reauthViaPopup":case"reauthViaRedirect":return tE;default:Oe(this.auth,"internal-error")}}resolve(e){tt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){tt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sE="pendingRedirect",os=new Map;class iE extends Zh{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=os.get(this.auth._key());if(!e){try{const r=await oE(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}os.set(this.auth._key(),e)}return this.bypassAuthState||os.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function oE(n,e){const t=uE(e),r=cE(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function aE(n,e){os.set(n._key(),e)}function cE(n){return Qe(n._redirectPersistence)}function uE(n){return is(sE,n.config.apiKey,n.name)}async function lE(n,e,t=!1){if(Me(n.app))return Promise.reject(Je(n));const r=Gt(n),s=Zy(r,e),a=await new iE(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hE=10*60*1e3;class dE{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!fE(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var r;if(e.error&&!ed(e)){const s=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";t.onError(Fe(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=hE&&this.cachedEventUids.clear(),this.cachedEventUids.has(iu(e))}saveEventToCache(e){this.cachedEventUids.add(iu(e)),this.lastProcessedEventTime=Date.now()}}function iu(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function ed({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function fE(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return ed(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const EE=new _r(3e4,6e4);function ou(){const n=Be().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function IE(n){return new Promise((e,t)=>{var r,s,i;function a(){ou(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ou(),t(Fe(n,"network-request-failed"))},timeout:EE.get()})}if(!((s=(r=Be().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=Be().gapi)===null||i===void 0)&&i.load)a();else{const u=fy("iframefcb");return Be()[u]=()=>{gapi.load?a():t(Fe(n,"network-request-failed"))},Mh(`${dy()}?onload=${u}`).catch(l=>t(l))}}).catch(e=>{throw as=null,e})}let as=null;function TE(n){return as=as||IE(n),as}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki="webStorageSupport";class BE{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Wh,this._completeRedirectFn=lE,this._overrideRedirectResult=aE}async _openPopup(e,t,r,s){var i;tt((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const a=await cu(e,t,r,Zi(),s);return VE(e,a,zo())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await cu(e,t,r,Zi(),s);return $y(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(tt(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await bE(e),r=new dE(e);return t.register("authEvent",s=>(M(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ki,{type:ki},s=>{var i;const a=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[ki];a!==void 0&&t(!!a),Oe(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=_E(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Vh()||bh()||$o()}}const qE=BE;var uu="@firebase/auth",lu="1.8.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $E(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function GE(n){an(new Mt("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:u}=r.options;M(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:a,authDomain:u,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Lh(n)},d=new uy(r,s,i,l);return Ey(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),an(new Mt("auth-internal",e=>{const t=Gt(e.getProvider("auth").getImmediate());return(r=>new jE(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),mt(uu,lu,$E(n)),mt(uu,lu,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HE=5*60,zE=xu("authIdTokenMaxAge")||HE;let hu=null;const KE=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>zE)return;const s=t==null?void 0:t.token;hu!==s&&(hu=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function WE(n=qu()){const e=io(n,"auth");if(e.isInitialized())return e.getImmediate();const t=yy(n,{popupRedirectResolver:qE,persistence:[Xy,zh,Wh]}),r=xu("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=KE(i.toString());Uy(t,a,()=>a(t.currentUser)),xy(t,u=>a(u))}}const s=Lu("auth");return s&&Iy(t,`http://${s}`),t}function QE(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}ly({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=Fe("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",QE().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});GE("Browser");const YE={apiKey:"AIzaSyDo9nRtzMTFaGFfGWgqlcksi5Y9h7x46x0",authDomain:"webdevtrends-59dcf.firebaseapp.com",projectId:"webdevtrends-59dcf",storageBucket:"webdevtrends-59dcf.appspot.com",messagingSenderId:"711058905449",appId:"1:711058905449:web:b29e4821f76656e45cc5f8"},td=Bu(YE),Lt=y_(td),Bt=WE(td);My(Bt,zh).then(()=>console.log("Auth persistence enabled")).catch(n=>console.error("Auth persistence error:",n));var du;(function(n){n.STRING="string",n.NUMBER="number",n.INTEGER="integer",n.BOOLEAN="boolean",n.ARRAY="array",n.OBJECT="object"})(du||(du={}));/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ce extends Error{constructor(e){super(`[GoogleGenerativeAI Error]: ${e}`)}}class Yt extends Ce{constructor(e,t){super(e),this.response=t}}class nd extends Ce{constructor(e,t,r,s){super(e),this.status=t,this.statusText=r,this.errorDetails=s}}class Et extends Ce{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(n){return n.text=()=>{if(n.candidates&&n.candidates.length>0){if(n.candidates.length>1&&console.warn(`This response had ${n.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),cs(n.candidates[0]))throw new Yt(`${ut(n)}`,n);return uI(n)}else if(n.promptFeedback)throw new Yt(`Text not available. ${ut(n)}`,n);return""},n.functionCall=()=>{if(n.candidates&&n.candidates.length>0){if(n.candidates.length>1&&console.warn(`This response had ${n.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),cs(n.candidates[0]))throw new Yt(`${ut(n)}`,n);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),vu(n)[0]}else if(n.promptFeedback)throw new Yt(`Function call not available. ${ut(n)}`,n)},n.functionCalls=()=>{if(n.candidates&&n.candidates.length>0){if(n.candidates.length>1&&console.warn(`This response had ${n.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),cs(n.candidates[0]))throw new Yt(`${ut(n)}`,n);return vu(n)}else if(n.promptFeedback)throw new Yt(`Function call not available. ${ut(n)}`,n)},n}function uI(n){var e,t,r,s;const i=[];if(!((t=(e=n.candidates)===null||e===void 0?void 0:e[0].content)===null||t===void 0)&&t.parts)for(const a of(s=(r=n.candidates)===null||r===void 0?void 0:r[0].content)===null||s===void 0?void 0:s.parts)a.text&&i.push(a.text),a.executableCode&&i.push("\n```"+a.executableCode.language+`
`+a.executableCode.code+"\n```\n"),a.codeExecutionResult&&i.push("\n```\n"+a.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}function vu(n){var e,t,r,s;const i=[];if(!((t=(e=n.candidates)===null||e===void 0?void 0:e[0].content)===null||t===void 0)&&t.parts)for(const a of(s=(r=n.candidates)===null||r===void 0?void 0:r[0].content)===null||s===void 0?void 0:s.parts)a.functionCall&&i.push(a.functionCall);if(i.length>0)return i}const lI=[Jn.RECITATION,Jn.SAFETY,Jn.LANGUAGE];function cs(n){return!!n.finishReason&&lI.includes(n.finishReason)}function ut(n){var e,t,r;let s="";if((!n.candidates||n.candidates.length===0)&&n.promptFeedback)s+="Response was blocked",!((e=n.promptFeedback)===null||e===void 0)&&e.blockReason&&(s+=` due to ${n.promptFeedback.blockReason}`),!((t=n.promptFeedback)===null||t===void 0)&&t.blockReasonMessage&&(s+=`: ${n.promptFeedback.blockReasonMessage}`);else if(!((r=n.candidates)===null||r===void 0)&&r[0]){const i=n.candidates[0];cs(i)&&(s+=`Candidate was blocked due to ${i.finishReason}`,i.finishMessage&&(s+=`: ${i.finishMessage}`))}return s}function ar(n){return this instanceof ar?(this.v=n,this):new ar(n)}function hI(n,e,t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var r=t.apply(n,e||[]),s,i=[];return s={},a("next"),a("throw"),a("return"),s[Symbol.asyncIterator]=function(){return this},s;function a(E){r[E]&&(s[E]=function(R){return new Promise(function(S,k){i.push([E,R,S,k])>1||u(E,R)})})}function u(E,R){try{l(r[E](R))}catch(S){y(i[0][3],S)}}function l(E){E.value instanceof ar?Promise.resolve(E.value.v).then(d,p):y(i[0][2],E)}function d(E){u("next",E)}function p(E){u("throw",E)}function y(E,R){E(R),i.shift(),i.length&&u(i[0][0],i[0][1])}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rd(n,e,t,r){const s=await Tr(e,qt.STREAM_GENERATE_CONTENT,n,!0,JSON.stringify(t),r);return dI(s)}async function sd(n,e,t,r){const i=await(await Tr(e,qt.GENERATE_CONTENT,n,!1,JSON.stringify(t),r)).json();return{response:Wo(i)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cu=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],II={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function TI(n){let e=!1;for(const t of n){const{role:r,parts:s}=t;if(!e&&r!=="user")throw new Ce(`First content should be with role 'user', got ${r}`);if(!gu.includes(r))throw new Ce(`Each item should include role field. Got ${r} but valid roles are: ${JSON.stringify(gu)}`);if(!Array.isArray(s))throw new Ce("Content should have 'parts' property with an array of Parts");if(s.length===0)throw new Ce("Each Content should have at least one part");const i={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(const u of s)for(const l of Cu)l in u&&(i[l]+=1);const a=II[r];for(const u of Cu)if(!a.includes(u)&&i[u]>0)throw new Ce(`Content with role '${r}' can't contain '${u}' part`);e=!0}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vI(n,e,t,r){return(await Tr(e,qt.COUNT_TOKENS,n,!1,JSON.stringify(t),r)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function AI(n,e,t,r){return(await Tr(e,qt.EMBED_CONTENT,n,!1,JSON.stringify(t),r)).json()}async function RI(n,e,t,r){const s=t.requests.map(a=>Object.assign(Object.assign({},a),{model:e}));return(await Tr(e,qt.BATCH_EMBED_CONTENTS,n,!1,JSON.stringify({requests:s}),r)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CI{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new Ce("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new bu(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,r){if(!e.name)throw new Et("Cached content must contain a `name` field.");if(!e.model)throw new Et("Cached content must contain a `model` field.");const s=["model","systemInstruction"];for(const a of s)if(t!=null&&t[a]&&e[a]&&(t==null?void 0:t[a])!==e[a]){if(a==="model"){const u=t.model.startsWith("models/")?t.model.replace("models/",""):t.model,l=e.model.startsWith("models/")?e.model.replace("models/",""):e.model;if(u===l)continue}throw new Et(`Different value for "${a}" specified in modelParams (${t[a]}) and cachedContent (${e[a]})`)}const i=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new bu(this.apiKey,i,r)}}const od=["meatList","dairyList","vegetablesList","fruitList","snacksList"],Ht={};od.forEach(n=>{Ht[n]=document.getElementById(n)});const Kr=Ht.meatList,Wr=Ht.dairyList,Qr=Ht.vegetablesList,Yr=Ht.fruitList,Jr=Ht.snacksList,SI=document.getElementById("email"),bI=document.getElementById("password"),PI=document.getElementById("regEmail"),kI=document.getElementById("regPass"),NI=document.getElementById("loginBtn"),DI=document.getElementById("registerLink"),bs=document.getElementById("login-form"),Pu=document.getElementById("main-container"),ad=document.getElementById("logoutBtn"),cd=document.getElementById("register-form"),OI=document.getElementById("registerUser"),VI=document.getElementById("addListBtn"),ud=document.getElementById("chat-input"),LI=document.getElementById("send-btn"),MI=document.getElementById("chat-history"),xI=document.getElementById("emptyList"),UI=document.getElementById("googleLogin");DI.addEventListener("click",n=>{n.preventDefault(),bs.style.display="none",cd.style.display="flex"});const FI=async(n,e)=>{try{const r=(await Vy(Bt,n,e)).user;await ld(r.uid,r.email),cd.style.display="none",bs.style.display="flex",await $h(Bt),alert("Registration successful.")}catch(t){alert("Registration failed: Email already in use."),console.error("Error during registration: ",t.message)}},ld=async(n,e)=>{try{const t=sr(Lt,"users",n);await mh(t,{email:e,createdAt:new Date}),console.log("User data with biometric credentials added to Firestore.")}catch(t){console.error("Error adding user to Firestore: ",t.message)}},BI=async(n,e)=>{if(!n||!e){alert("Email and password are required.");return}try{const t=await Ly(Bt,n,e);alert("Login successful.")}catch(t){console.error("Login error:",t.message),t.code==="auth/invalid-credential"?alert("Login failed: Incorrect password."):alert("Login failed: "+t.message)}};NI.addEventListener("click",async()=>{const n=SI.value,e=bI.value;await BI(n,e)});UI.addEventListener("click",async()=>{const n=new ze;try{const t=(await signInWithPopup(Bt,n)).user;await ld(t.uid,t.email),alert("Login successful.")}catch(e){console.error("Login error:",e.message),alert("Login failed: "+e.message)}});OI.addEventListener("click",async()=>{const n=PI.value,e=kI.value;await FI(n,e)});ad.addEventListener("click",async()=>{try{await $h(Bt),window.location.reload(),alert("Logged out successfully.")}catch(n){console.error("Error signing out:",n)}});function qI(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}Bt.onAuthStateChanged(n=>{if(n){let s=function(){const p=JSON.parse(localStorage.getItem("items"))||[];Kr.innerHTML="",Wr.innerHTML="",Qr.innerHTML="",Yr.innerHTML="",Jr.innerHTML="",p.filter(E=>!E.completed).forEach(E=>{const R=document.createElement("li");switch(R.textContent=E.name,R.id=E.id,R.setAttribute("tabindex","0"),E.completed&&(R.style.textDecoration="line-through"),E.category){case"meat":Kr.appendChild(R);break;case"dairy":Wr.appendChild(R);break;case"vegetables":Qr.appendChild(R);break;case"fruits":Yr.appendChild(R);break;case"snacks":Jr.appendChild(R);break}}),Ve("meatList"),Ve("dairyList"),Ve("vegetablesList"),Ve("fruitList"),Ve("snacksList")};ad.style.display="block",bs.style.display="none",Pu.style.display="block";const e=n.uid;window.addEventListener("online",async()=>{await jI(e),await i()});const t=async(p,y)=>{try{const E=Ji(Lt,"groceries",p,"list");for(const R of y)await _h(E,R)}catch(E){console.error("Error adding document: ",E)}};VI.addEventListener("click",async()=>{const p=document.getElementById("listInput"),y=document.getElementById("category").value,E=qI(p.value.trim());E&&(us()?(await t(e,[{name:E,category:y,completed:!1}]),await i(),liveRegion.textContent=`New list added: ${E}`):(Nu(E,y),liveRegion.textContent=`List saved locally: ${E}`,s()),p.value="")}),Object.values(Ht).forEach(p=>{p.addEventListener("click",async y=>{if(y.target.tagName==="LI"){const E=y.target.id,R=y.target.textContent;if(!E){console.error("No item ID found on the clicked element");return}if(us())try{await M_(sr(Lt,"groceries",e,"list",E),{completed:!0}),liveRegion.textContent="Completed.",setTimeout(async()=>{await i(),liveRegion.textContent="Ready.",console.log(liveRegion.textContent)},1e3)}catch(S){console.error("Error updating document: ",S),liveRegion.textContent="Error: Could not complete the item."}else{const S=JSON.parse(localStorage.getItem("items"))||[],k=S.find(D=>D.name===R);k&&(k.completed=!0,localStorage.setItem("items",JSON.stringify(S)),liveRegion.textContent="List marked as complete.",s())}}})});const r=async p=>{try{const y=Ji(Lt,"groceries",p,"list");return(await gh(y)).docs.map(S=>({id:S.id,...S.data()}))}catch(y){return console.error("Error fetching grocery list: ",y),[]}},i=async()=>{const p=await r(e),y=JSON.parse(localStorage.getItem("items"))||[],R=[...p,...y].filter((S,k,D)=>k===D.findIndex(j=>j.id===S.id||j.name===S.name&&j.category===S.category));Kr.innerHTML="",Wr.innerHTML="",Qr.innerHTML="",Yr.innerHTML="",Jr.innerHTML="",R.forEach(S=>{if(!S.completed){let k=document.createElement("li");switch(k.textContent=S.name,k.id=S.id,k.setAttribute("tabindex","0"),Nu(S.name,S.category),S.completed&&(k.style.textDecoration="line-through"),S.category){case"meat":Kr.appendChild(k);break;case"dairy":Wr.appendChild(k);break;case"vegetables":Qr.appendChild(k);break;case"fruits":Yr.appendChild(k);break;case"snacks":Jr.appendChild(k);break}}}),Ve("meatList"),Ve("dairyList"),Ve("vegetablesList"),Ve("fruitList"),Ve("snacksList")};us()?(i(),u()):s();let a;async function u(){const y=(await L_(sr(Lt,"apikey","googlegenai"))).data().key;a=new CI(y).getGenerativeModel({model:"gemini-1.5-flash"})}async function l(p){return await a.generateContent(p)}LI.addEventListener("click",async()=>{let p=ud.value.trim().toLowerCase();p?(console.log("Prompt: ",p),d(p)||l(p)):ct("Please enter a prompt")});async function d(p){const y=/add\s+(.+?)\s+(?:to|in)\s+(\w+)/i,E=p.match(y);if(console.log("Match: ",E),E){const R=E[1].trim(),S=E[2].trim();if(R&&S)try{await t(e,[{name:R,category:S,completed:!1}]),ct(`${R} added to ${S} category.`),await i()}catch(k){ct("Error adding to Firestore: "+k.message)}else ct("Please provide both the item and category.");return!0}else if(p.startsWith("complete")){let R=p.replace("complete","").trim();if(R)try{result?ct("List "+R+" marked as complete."):ct("List not found!")}catch(S){ct("Error marking list as complete: "+S.message)}else ct("Please specify a list to complete.");return!0}return!1}}else bs.style.display="flex",Pu.style.display="none"});const ku="/WebDevTrends/service-worker.js";"serviceWorker"in navigator&&navigator.serviceWorker.register(ku,{scope:"/WebDevTrends/"}).then(e=>console.log("Service Worker Registered for scope:",ku,"with",import.meta.url)).catch(e=>console.error("Service Worker Error:",e));function ct(n){let e=document.createElement("div");e.textContent=n,e.className="history",MI.appendChild(e),ud.value=""}function Ve(n){let e=document.querySelector(`#${n}`).closest(".list-category");if(e){const r=e.querySelector("ul");r&&r.children.length===0?e.style.display="none":e.style.display="block"}const t=od.every(r=>document.querySelectorAll(`#${r} li`).length===0);xI.style.display=t?"block":"none"}document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("chatbot-container"),e=document.getElementById("chatbot-toggle"),t=document.getElementById("hide-chat");e.addEventListener("click",()=>{n.style.display="block",e.style.display="none"}),t.addEventListener("click",()=>{n.style.display="none",e.style.display="inline-block"})});const Nu=(n,e,t)=>{const r=JSON.parse(localStorage.getItem("items"))||[];if(!r.some(i=>i.name===n&&i.category===e)){const i={name:n,category:e,completed:!1};r.push(i),localStorage.setItem("items",JSON.stringify(r))}},us=()=>navigator.onLine,jI=async n=>{if(us()){const e=JSON.parse(localStorage.getItem("items"))||[];if(e.length>0)try{const t=Ji(Lt,"groceries",n,"list");for(const r of e){const s=k_(t,N_("name","==",r.name)),i=await gh(s);if(i.empty)await _h(t,r);else{const a=sr(Lt,"groceries",n,"list",i.docs[0].id);await mh(a,r,{merge:!0})}}localStorage.removeItem("items")}catch(t){console.error("Failed to sync items with Firestore:",t)}}};
