 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const df="FirebaseError";class tt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=df,Object.setPrototypeOf(this,tt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,cr.prototype.create)}}class cr{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?ff(i,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new tt(s,u,r)}}function ff(n,e){return n.replace(pf,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const pf=/\{\$([^}]+)}/g;function gf(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function hs(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],a=e[s];if(Ya(i)&&Ya(a)){if(!hs(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Ya(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rp(n){on(new Mt("platform-logger",e=>new Uf(e),"PRIVATE")),on(new Mt("heartbeat",e=>new wp(e),"PRIVATE")),mt(Oi,ec,n),mt(Oi,ec,"esm2017"),mt("fire-js","")}Rp("");var Cp="firebase",Sp="11.2.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mr{constructor(e,t){this.shortDelay=e,this.longDelay=t,et(t>e,"Short delay should be less than long delay!"),this.isMobile=nf()||af()}get(){return q_()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof tt&&J_(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function J_({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function As(n){var e;const t=n.auth,r=await n.getIdToken(),s=await sr(n,Ah(t,{idToken:r}));M(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?Rh(i.providerUserInfo):[],u=ey(n.providerData,a),l=n.isAnonymous,d=!(n.email&&i.passwordHash)&&!(u!=null&&u.length),p=l?d:!1,y={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:u,metadata:new eo(i.createdAt,i.lastLoginAt),isAnonymous:p};Object.assign(n,y)}async function Z_(n){const e=ce(n);await As(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function ey(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Rh(n){return n.map(e=>{var{providerId:t}=e,r=Fo(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return ze("not implemented")}_getIdTokenResponse(e){return ze("not implemented")}_linkToIdToken(e,t){return ze("not implemented")}_getReauthenticationResolver(e){return ze("not implemented")}}async function vy(n,e){return bt(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ay(n,e){return _r(n,"POST","/v1/accounts:signInWithPassword",St(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ry(n,e){return _r(n,"POST","/v1/accounts:signInWithEmailLink",St(n,e))}async function Cy(n,e){return _r(n,"POST","/v1/accounts:signInWithEmailLink",St(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function by(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Py(n){const e=Fn(Bn(n)).link,t=e?Fn(Bn(e)).deep_link_id:null,r=Fn(Bn(n)).deep_link_id;return(r?Fn(Bn(r)).link:null)||r||t||e||n}class Ho{constructor(e){var t,r,s,i,a,u;const l=Fn(Bn(e)),d=(t=l.apiKey)!==null&&t!==void 0?t:null,p=(r=l.oobCode)!==null&&r!==void 0?r:null,y=by((s=l.mode)!==null&&s!==void 0?s:null);M(d&&p&&y,"argument-error"),this.apiKey=d,this.operation=y,this.code=p,this.continueUrl=(i=l.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(a=l.languageCode)!==null&&a!==void 0?a:null,this.tenantId=(u=l.tenantId)!==null&&u!==void 0?u:null}static parseLink(e){const t=Py(e);try{return new Ho(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ky(n,e){return _r(n,"POST","/v1/accounts:signUp",St(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qh(n,e,t=!1){if(Me(n.app))return Promise.reject(Ye(n));const r="signIn",s=await Bh(n,r,e),i=await Ft._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Oy(n,e){return qh($t(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jh(n){const e=$t(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Vy(n,e,t){if(Me(n.app))return Promise.reject(Ye(n));const r=$t(n),a=await to(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",ky).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&jh(n),l}),u=await Ft._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(u.user),u}function Ly(n,e,t){return Me(n.app)?Promise.reject(Ye(n)):Oy(ce(n),Tn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&jh(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function My(n,e){return ce(n).setPersistence(e)}function xy(n,e,t,r){return ce(n).onIdTokenChanged(e,t,r)}function Uy(n,e,t){return ce(n).beforeAuthStateChanged(e,t)}function Fy(n){return ce(n).signOut()}const Cs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wh(){return typeof Be().WorkerGlobalScope<"u"&&typeof Be().importScripts=="function"}async function Hy(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function zy(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Ky(){return Wh()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xh{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:u}=e;if(a){this.reject(a);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(u)(l))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return tE;case"linkViaPopup":case"linkViaRedirect":return rE;case"reauthViaPopup":case"reauthViaRedirect":return nE;default:Oe(this.auth,"internal-error")}}resolve(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dE=10*60*1e3;class fE{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!pE(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var r;if(e.error&&!Zh(e)){const s=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";t.onError(Fe(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=dE&&this.cachedEventUids.clear(),this.cachedEventUids.has(iu(e))}saveEventToCache(e){this.cachedEventUids.add(iu(e)),this.lastProcessedEventTime=Date.now()}}function iu(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Zh({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function pE(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Zh(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gE(n,e={}){return bt(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vE=new mr(5e3,15e3),AE="__/auth/iframe",RE="emulator/auth/iframe",CE={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},SE=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function bE(n){const e=n.config;M(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?qo(e,RE):`https://${n.config.authDomain}/${AE}`,r={apiKey:e.apiKey,appName:n.name,v:pn},s=SE.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${ur(r).slice(1)}`}async function PE(n){const e=await wE(n),t=Be().gapi;return M(t,n,"internal-error"),e.open({where:document.body,url:bE(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:CE,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const a=Fe(n,"network-request-failed"),u=Be().setTimeout(()=>{i(a)},vE.get());function l(){Be().clearTimeout(u),s(r)}r.ping(l).then(l,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GE(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function HE(n){on(new Mt("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:u}=r.options;M(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:a,authDomain:u,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Lh(n)},d=new uy(r,s,i,l);return Ey(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),on(new Mt("auth-internal",e=>{const t=$t(e.getProvider("auth").getImmediate());return(r=>new $E(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),mt(uu,lu,GE(n)),mt(uu,lu,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nd(n,e,t,r){const s=await Tr(e,Bt.STREAM_GENERATE_CONTENT,n,!0,JSON.stringify(t),r);return fI(s)}async function rd(n,e,t,r){const i=await(await Tr(e,Bt.GENERATE_CONTENT,n,!1,JSON.stringify(t),r)).json();return{response:Wo(i)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SI{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new Ce("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new bu(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,r){if(!e.name)throw new Et("Cached content must contain a `name` field.");if(!e.model)throw new Et("Cached content must contain a `model` field.");const s=["model","systemInstruction"];for(const a of s)if(t!=null&&t[a]&&e[a]&&(t==null?void 0:t[a])!==e[a]){if(a==="model"){const u=t.model.startsWith("models/")?t.model.replace("models/",""):t.model,l=e.model.startsWith("models/")?e.model.replace("models/",""):e.model;if(u===l)continue}throw new Et(`Different value for "${a}" specified in modelParams (${t[a]}) and cachedContent (${e[a]})`)}const i=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new bu(this.apiKey,i,r)}}const id=["meatList","dairyList","vegetablesList","fruitList","snacksList"],Gt={};id.forEach(n=>{Gt[n]=document.getElementById(n)});const Kr=Gt.meatList,Wr=Gt.dairyList,Qr=Gt.vegetablesList,Yr=Gt.fruitList,Jr=Gt.snacksList,od=document.getElementById("email"),ad=document.getElementById("password"),bI=document.getElementById("loginBtn"),bs=document.getElementById("login-form"),Pu=document.getElementById("main-container"),PI=document.getElementById("registerBtn"),cd=document.getElementById("logoutBtn"),ud=document.getElementById("register-form"),kI=document.getElementById("registerUser");document.getElementById("loginUser");document.getElementById("listInput");document.getElementById("category");const NI=document.getElementById("addListBtn");document.getElementById("itemList");const ld=document.getElementById("chat-input"),DI=document.getElementById("send-btn"),OI=document.getElementById("chat-history"),VI=document.getElementById("emptyList"),LI=async(n,e)=>{try{const r=(await Vy(Ir,n,e)).user;await MI(r.uid,r.email),ud.style.display="none",bs.style.display="flex",alert("Registration successful.")}catch(t){console.error("Error during registration: ",t.message)}},MI=async(n,e)=>{try{const t=rr(Lt,"users",n);await mh(t,{email:e,createdAt:new Date})}catch(t){console.error("Error adding user to Firestore: ",t.message)}},xI=async(n,e)=>{if(!n||!e){console.error("Email and password are required.");return}try{const t=await Ly(Ir,n,e);alert("Login successful.")}catch(t){console.error("Login error:",t.message),alert("Login failed: "+t.message)}};bI.addEventListener("click",async()=>{const n=od.value,e=ad.value;await xI(n,e)});PI.addEventListener("click",()=>{bs.style.display="none",ud.style.display="flex"});kI.addEventListener("click",async()=>{const n=od.value,e=ad.value;await LI(n,e)});cd.addEventListener("click",async()=>{try{await Fy(Ir),window.location.reload(),alert("Logged out successfully.")}catch(n){console.error("Error signing out:",n)}});function UI(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}Ir.onAuthStateChanged(n=>{if(n){let s=function(){const p=JSON.parse(localStorage.getItem("items"))||[];Kr.innerHTML="",Wr.innerHTML="",Qr.innerHTML="",Yr.innerHTML="",Jr.innerHTML="",p.filter(E=>!E.completed).forEach(E=>{const R=document.createElement("li");switch(R.textContent=E.name,R.id=E.id,R.setAttribute("tabindex","0"),E.completed&&(R.style.textDecoration="line-through"),E.category){case"meat":Kr.appendChild(R);break;case"dairy":Wr.appendChild(R);break;case"vegetables":Qr.appendChild(R);break;case"fruits":Yr.appendChild(R);break;case"snacks":Jr.appendChild(R);break}}),Ve("meatList"),Ve("dairyList"),Ve("vegetablesList"),Ve("fruitList"),Ve("snacksList")};cd.style.display="block",bs.style.display="none",Pu.style.display="block";const e=n.uid;window.addEventListener("online",async()=>{await FI(e),await i()});const t=async(p,y)=>{try{const E=Ji(Lt,"groceries",p,"list");for(const R of y)await _h(E,R)}catch(E){console.error("Error adding document: ",E)}};NI.addEventListener("click",async()=>{const p=document.getElementById("listInput"),y=document.getElementById("category").value,E=UI(p.value.trim());E&&(us()?(await t(e,[{name:E,category:y,completed:!1}]),await i(),liveRegion.textContent=`New list added: ${E}`):(Nu(E,y),liveRegion.textContent=`List saved locally: ${E}`,s()),p.value="")}),Object.values(Gt).forEach(p=>{p.addEventListener("click",async y=>{if(y.target.tagName==="LI"){const E=y.target.id,R=y.target.textContent;if(!E){console.error("No item ID found on the clicked element");return}if(us())try{await M_(rr(Lt,"groceries",e,"list",E),{completed:!0}),liveRegion.textContent="Completed.",setTimeout(async()=>{await i(),liveRegion.textContent="Ready.",console.log(liveRegion.textContent)},1e3)}catch(S){console.error("Error updating document: ",S),liveRegion.textContent="Error: Could not complete the item."}else{const S=JSON.parse(localStorage.getItem("items"))||[],k=S.find(D=>D.name===R);k&&(k.completed=!0,localStorage.setItem("items",JSON.stringify(S)),liveRegion.textContent="List marked as complete.",s())}}})});const r=async p=>{try{const y=Ji(Lt,"groceries",p,"list");return(await gh(y)).docs.map(S=>({id:S.id,...S.data()}))}catch(y){return console.error("Error fetching grocery list: ",y),[]}},i=async()=>{const p=await r(e),y=JSON.parse(localStorage.getItem("items"))||[],R=[...p,...y].filter((S,k,D)=>k===D.findIndex(j=>j.id===S.id||j.name===S.name&&j.category===S.category));Kr.innerHTML="",Wr.innerHTML="",Qr.innerHTML="",Yr.innerHTML="",Jr.innerHTML="",R.forEach(S=>{if(!S.completed){let k=document.createElement("li");switch(k.textContent=S.name,k.id=S.id,k.setAttribute("tabindex","0"),Nu(S.name,S.category),S.completed&&(k.style.textDecoration="line-through"),S.category){case"meat":Kr.appendChild(k);break;case"dairy":Wr.appendChild(k);break;case"vegetables":Qr.appendChild(k);break;case"fruits":Yr.appendChild(k);break;case"snacks":Jr.appendChild(k);break}}}),Ve("meatList"),Ve("dairyList"),Ve("vegetablesList"),Ve("fruitList"),Ve("snacksList")};us()?(i(),u()):s();let a;async function u(){const y=(await L_(rr(Lt,"apikey","googlegenai"))).data().key;a=new SI(y).getGenerativeModel({model:"gemini-1.5-flash"})}async function l(p){return await a.generateContent(p)}DI.addEventListener("click",async()=>{let p=ld.value.trim().toLowerCase();p?(console.log("Prompt: ",p),d(p)||l(p)):at("Please enter a prompt")});async function d(p){const y=/add\s+(.+?)\s+(?:to|in)\s+(\w+)/i,E=p.match(y);if(console.log("Match: ",E),E){const R=E[1].trim(),S=E[2].trim();if(R&&S)try{await t(e,[{name:R,category:S,completed:!1}]),at(`${R} added to ${S} category.`),await i()}catch(k){at("Error adding to Firestore: "+k.message)}else at("Please provide both the item and category.");return!0}else if(p.startsWith("complete")){let R=p.replace("complete","").trim();if(R)try{result?at("List "+R+" marked as complete."):at("List not found!")}catch(S){at("Error marking list as complete: "+S.message)}else at("Please specify a list to complete.");return!0}return!1}}else bs.style.display="flex",Pu.style.display="none"});const ku="/WebDevTrends/service-worker.js";"serviceWorker"in navigator&&navigator.serviceWorker.register(ku,{scope:"/WebDevTrends/"}).then(e=>console.log("Service Worker Registered for scope:",ku,"with",import.meta.url)).catch(e=>console.error("Service Worker Error:",e));function at(n){let e=document.createElement("div");e.textContent=n,e.className="history",OI.appendChild(e),ld.value=""}function Ve(n){let e=document.querySelector(`#${n}`).closest(".list-category");if(e){const r=e.querySelector("ul");r&&r.children.length===0?e.style.display="none":e.style.display="block"}const t=id.every(r=>document.querySelectorAll(`#${r} li`).length===0);VI.style.display=t?"block":"none"}document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("chatbot-container"),e=document.getElementById("chatbot-toggle"),t=document.getElementById("hide-chat");e.addEventListener("click",()=>{n.style.display="block",e.style.display="none"}),t.addEventListener("click",()=>{n.style.display="none",e.style.display="inline-block"})});const Nu=(n,e,t)=>{const r=JSON.parse(localStorage.getItem("items"))||[];if(!r.some(i=>i.name===n&&i.category===e)){const i={name:n,category:e,completed:!1};r.push(i),localStorage.setItem("items",JSON.stringify(r))}},us=()=>navigator.onLine,FI=async n=>{if(us()){const e=JSON.parse(localStorage.getItem("items"))||[];if(e.length>0)try{const t=Ji(Lt,"groceries",n,"list");for(const r of e){const s=k_(t,N_("name","==",r.name)),i=await gh(s);if(i.empty)await _h(t,r);else{const a=rr(Lt,"groceries",n,"list",i.docs[0].id);await mh(a,r,{merge:!0})}}localStorage.removeItem("items")}catch(t){console.error("Failed to sync items with Firestore:",t)}}};
