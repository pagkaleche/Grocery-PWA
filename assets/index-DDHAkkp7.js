 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bl="FirebaseError";class Ve extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=bl,Object.setPrototypeOf(this,Ve.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,oa.prototype.create)}}class oa{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],u=o?Vl(o,r):"Error",c=`${this.serviceName}: ${u} (${s}).`;return new Ve(s,c,r)}}function Vl(n,t){return n.replace(Dl,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const Dl=/\{\$([^}]+)}/g;function is(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],u=t[s];if(ao(o)&&ao(u)){if(!is(o,u))return!1}else if(o!==u)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function ao(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sh=new Y(L.comparator);function Ft(){return Sh}const Na=new Y(L.comparator);function Ze(...n){let t=Na;for(const e of n)t=t.insert(e.key,e);return t}function xa(n){let t=Na;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function ue(){return rn()}function La(){return rn()}function rn(){return new he(n=>n.toString(),(n,t)=>n.isEqual(t))}const Ph=new Y(L.comparator),bh=new rt(L.comparator);function U(...n){let t=bh;for(const e of n)t=t.add(e);return t}const Vh=new rt(B);function Dh(){return Vh}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xs(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:tr(t)?"-0":t}}function Ma(n){return{integerValue:""+n}}function kh(n,t){return ih(t)?Ma(t):xs(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
